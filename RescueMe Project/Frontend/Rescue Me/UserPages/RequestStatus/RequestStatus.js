...
// const COMPANY_PAYMENT_NUMBER = "01119463672"; // ← رقم المنقذ الثابت
...
// // ✅ فانكشن جديدة ترفع طريقة الدفع للـ API
...
//     try {
//         // تأكد أن الرابط يطابق الـ Controller
//         const res = await fetch(`http://localhost:5065/api/Orders/paymob/${orderId}`);
//         const data = await res.json();
